...
locations around Perak. Multilingual interface
...
This release migrates Perak from the older forecast-only build onto
...
|---|---|---|---|---|
| Chenderiang | 积莪营 | 4.256043, 101.227729 | open plain | durian |
| Sungkai | 宋溪 | 3.978889, 101.360278 | open plain | durian |
| Diamond Creeks | 钻石溪 | 3.77550, 101.52567 | riverine | durian |
| Tanjung Malim | 丹绒马林 | 3.71778, 101.55278 | open plain | durian |
...
The app also seeds a default user display name (**胡瑞良 / Stanley Woo**),
which stays editable via **Edit Name** in the app.

This build carries the seed version **`pk-arch1`** (the lowland-architecture
...
```
wnext-weathernextforperak-202606091230
```
...
- **Storage namespace:** `weathernextforperak__*` keys in `localStorage`, isolated
...
The icon shows an orchard with a winding creek under a blue sky. The boot screen
background (sky-blue `#82c6f0`) is matched to the icon's sky.
